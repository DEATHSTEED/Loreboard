...
const LB_MODULE_ID = "loreboard-lite";
...
const DISCORD_URL = "";
const PATREON_URL = "";
const LB_ASSET_BASE = "modules/loreboard-lite/assets/graphics";
const LB_SOUND_BASE = "modules/loreboard-lite/assets/sounds";
...
const LB_DRAW_MASKS = [
    ...
    "modules/loreboard-lite/assets/graphics/Mask2.png",
    "modules/loreboard-lite/assets/graphics/Mask3.png"
];
