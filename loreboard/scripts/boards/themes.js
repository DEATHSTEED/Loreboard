...
const LB_THEMES = [
    ...
    { id: "cosytavern", name: "The Cozy Tavern", bg: "modules/loreboard/assets/graphics/CosyTavern.webp", fg: "", files: "", accent: "#e0822e" },
    // #1 Galactic: GalaxyBack stays fixed fullscreen (never zoom/pan); GalaxyFront is the zoom/pan board surface → parallax.
    { id: "galactic", name: "Galactic", bg: LB_GALAXY_BACK, fg: "modules/loreboard/assets/graphics/GalaxyFront.webp", files: "", accent: "#4ea8ff", parallax: true },
    { id: "shadowpunk", name: "Shadowpunk", bg: "modules/loreboard/assets/graphics/Shadowpunk.webp", fg: "", files: "modules/loreboard/assets/graphics/ShadowpunkFile.webp", accent: "#ff00ff" },
    { id: "slums", name: "Slums", bg: "modules/loreboard/assets/graphics/SlumsBack.webp", fg: "", files: "", accent: "#8a9a5b" },
    { id: "noir", name: "1920 Noir", bg: "modules/loreboard/assets/graphics/Noir.webp", fg: "modules/loreboard/assets/graphics/NoirFront.webp", files: "modules/loreboard/assets/graphics/BoardNoirFiles.webp", accent: "#d4af37" },
    { id: "modern", name: "Modern Office", bg: "modules/loreboard/assets/graphics/ModernOfficeBack.webp", fg: "modules/loreboard/assets/graphics/ModernOfficeFront.webp", files: "modules/loreboard/assets/graphics/ModernOfficeFile.webp", accent: "#4a90d9" }
];
        ...
        boards: [
            {
                id: "corkboard",
                title: "Corkboard",
                image: "modules/loreboard/assets/graphics/classiccorkthumb.webp",
            ...
            },
            {
                id: "whiteboard",
                title: "Whiteboard",
                image: "modules/loreboard/assets/graphics/classicwhiteboardthumb.webp",
            ...
            },
            {
                ...
                image: "modules/loreboard/assets/graphics/classicmetalthumb.webp",
            ...
            },
            {
                id: "wooden-board",
                title: "Wooden Board",
                image: "modules/loreboard/assets/graphics/classicwoodthumb.webp",
        ...
        boards: [
            {
                ...
                themeId: "cosytavern",
                image: "modules/loreboard/assets/graphics/CosyTavernthumb.webp",
            ...
            },
            {
                ...
                themeId: "noir",
                image: "modules/loreboard/assets/graphics/Noirthumb.webp",
            ...
            },
            {
                ...
                title: "The Hideout",
                themeId: "shadowpunk",
                image: "modules/loreboard/assets/graphics/Shadowpunkthumb.webp",
            ...
            },
            {
                ...
                title: "Rundown Hole",
                themeId: "slums",
                image: "modules/loreboard/assets/graphics/SlumsBackthumb.webp",
            ...
            },
            {
                ...
                title: "The Office",
                themeId: "modern",
                image: "modules/loreboard/assets/graphics/ModernOfficeBackthumb.webp",
...
function lbCreateBoardBindEvents(ov, close, cfg) {
    ...
    let openCustomUpload = () => {
        lbOpenCustomBoardUploadOverlay({
            ...
            onDone: async (res) => {
                if (!res.bg) return;
                cfg.customBoards.push({ id: foundry.utils.randomID(), name: res.name || "Custom Board", bg: res.bg || "", fg: "", bgFit: res.bgFit || null });
    ...
    ov.on('click', '.lb-create-custom-edit', function(e) {
        ...
        lbOpenCustomBoardUploadOverlay({
            ...
            onDone: async (res) => {
                ...
                if (res.fg !== null && res.fg !== undefined) cb.fg = res.fg;
                if (res.name) cb.name = res.name;
                if (res.bgFit) cb.bgFit = res.bgFit;
                await lbWriteConfig(cfg);
                render(null);
            }
        });
    ...
    ov.find('#lb-create-confirm').on('click', async () => {
        ...
        let customClassic = board.customBoard && board.customData
            ? { name: board.customData.name, bg: board.customData.bg || "", fg: board.customData.fg || LB_CUSTOM_BOARD_DEFAULT_FG_URL, customBoard: true, bgFit: board.customData.bgFit || null }
            : null;
