...
const DISCORD_URL = "";
const PATREON_URL = "";
const LB_ASSET_BASE = "modules/loreboard/assets/graphics";
const LB_SOUND_BASE = "modules/loreboard/assets/sounds";
...
const LB_DRAW_MASKS = [
    ...
    "modules/loreboard/assets/graphics/Mask2.png",
    "modules/loreboard/assets/graphics/Mask3.png"
];
